...
create trigger dbo.office_and_route_trigger_insert
	...
	as
	begin
		INSERT INTO ControllersOffice(Address) SELECT name FROM inserted as i --WHERE not EXISTS  (SELECT Address FROM ControllersOffice as c WHERE c.Address = i.name)
...
('pyskina 11','bus station5',143),
('pyskina 11','bus station6',142),
('pyskina 11','bus station7',141)

select * from ControllersOffice co 
--del
